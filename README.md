...
- النموذج يتنبأ باحتمال نجاح الصفقة (الوصول إلى TP قبل SL) لكل اتجاه.
...
- تمت إضافة `gold_strategy.py` كمكوّن مستقل لاختبار نطاق الجلسة الآسيوية، اختراق لندن، تأكيد الزخم، ومستويات ATR؛ لم يتم تفعيله في مسار الإشارات الحي قبل إجراء Backtest مستقل.
